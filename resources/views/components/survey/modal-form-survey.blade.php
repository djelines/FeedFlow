<div id="create-survey-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-3xl">
        ...
        <button
            ...
            class="absolute top-4 right-4 text-gray-500 hover:text-gray-900 dark:text-gray-400"
        >
            ✕
        </button>

        <div class="bg-surface dark:bg-surface-soft-dark border border-t-4 border-accent dark:border-accent-dark rounded-2xl shadow-2xl p-6">
            ...
            <form method="POST" action="{{ route('survey.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        class="bg-background dark:bg-background-dark border border-bordercolor dark:border-bordercolor-dark
                            ...
                            focus:-translate-y-[1px] focus:shadow-md placeholder:text-black/50 dark:placeholder:text-white/50"
                    />
                    @error('title')
                ...
                <button
                    ...
                    class="relative overflow-hidden inline-flex items-center justify-center w-full text-sm font-medium text-white rounded-lg px-5 py-2.5
                        shadow-md transition-transform duration-150 hover:-translate-y-[1px]
                        bg-gradient-to-r from-primary to-accent dark:from-primary-dark dark:to-accent-dark
                        before:absolute before:inset-0 before:-z-10 before:bg-primary-noise dark:before:bg-primary-noise-dark
                        before:bg-[length:260%_260%] before:bg-center before:opacity-0 before:transition-opacity before:duration-200
